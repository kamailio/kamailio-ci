...
RUN echo "Prepare base image filelist" \
    ...
    && apk add --no-cache abuild git gcc build-base bison db-dev gawk flex expat-dev perl-dev postgresql-dev python2-dev python3-dev pcre-dev mariadb-dev \
         ...
         wireshark-common tcpdump mongo-c-driver \
